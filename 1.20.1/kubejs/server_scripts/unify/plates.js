...
ServerEvents.recipes(event => {
  ...
  if (global.devLogging) {
    console.log(`Added Plate Recipes - Create: ${plateCount.create}, IE: ${plateCount.ie}, Thermal: ${plateCount.thermal}, Ad Astra: ${plateCount.adastra}`)
    //Added Plate Recipes - Create: 21, IE: 13, Thermal: 11, Ad Astra: 32
  }
