...
ServerEvents.recipes(event => {
    ...
    BYGWoodTypes.forEach((wood_type) => {
        ...
        }).damageIngredient(1).keepIngredient('#forge:tools/axes').id(`kubejs:byg/${wood_type}_planks`)
        //=== Saw ===
        event.shaped(`4x byg:${wood_type}_planks`, ['A', 'B'], {
            A: '#forge:saws',
            B: `#byg:${wood_type}_logs`
        }).damageIngredient(1).keepIngredient('#forge:saws').id(`kubejs:byg/${wood_type}_planks_saw`)
    ...
    }).damageIngredient(1).keepIngredient('#forge:tools/axes').id(`kubejs:myrtrees/rubberwood_planks`)
    //=== Saw ===
    event.shaped('4x myrtrees:rubberwood_planks', ['A', 'B'], {
        A: '#forge:saws',
        B: 'myrtrees:rubberwood_log'
    }).damageIngredient(1).keepIngredient('#forge:saws').id(`kubejs:myrtrees/rubberwood_planks_saw`)
    ...
    }).damageIngredient(1).keepIngredient('#forge:tools/axes').id(`kubejs:forbidden_arcanus/cherry_planks`)
    ...
    event.shaped('4x forbidden_arcanus:cherry_planks', ['A', 'B'], {
        A: '#forge:saws',
        B: '#forbidden_arcanus:cherrywood_logs'
    }).damageIngredient(1).keepIngredient('#forge:saws').id(`kubejs:forbidden_arcanus/cherry_planks_saw`)
    ...
    //===== Orcz =====
    //=== Axe ===
    event.shaped('2x orcz:orc_wood_planks', ['A', 'B'], {
        A: '#forge:tools/axes',
        B: '#forge:orc_wood_log'
    }).damageIngredient(1).keepIngredient('#forge:tools/axes').id(`kubejs:orcz/orc_wood_planks`)
    //=== Saw ===
    event.shaped('4x orcz:orc_wood_planks', ['A', 'B'], {
        A: '#forge:saws',
        B: '#forge:orc_wood_log'
    }).damageIngredient(1).keepIngredient('#forge:saws').id(`kubejs:orcz/orc_wood_planks_saw`)
    ...
    TinkersWoodTypes.forEach((wood_type) => {
        ...
        }).damageIngredient(1).keepIngredient('#forge:tools/axes').id(`kubejs:tconstruct/${wood_type}_planks`)
        //=== Saw ===
        event.shaped(`4x tconstruct:${wood_type}_planks`, ['A', 'B'], {
            A: '#forge:saws',
            B: `#tconstruct:${wood_type}_logs`
        }).damageIngredient(1).keepIngredient('#forge:saws').id(`kubejs:tconstruct/${wood_type}_planks_saw`)
