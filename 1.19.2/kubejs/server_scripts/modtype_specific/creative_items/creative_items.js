...
/*
  ...
  ☻/ Recipe Creative Items Event Handler
  /▌
  /\﻿
...
ServerEvents.recipes(event => {
    ...
    event.custom({
        ...
        ingredients: [
            ...
            Item.of('ars_nouveau:amulet_of_mana_regen', '{affix_data:{affixes:{"apotheosis:socket":1.0f}}}').strongNBT().toJson(),
            {item: "kubejs:personal_id"},
            {item: "botania:gaia_ingot"},
            Item.of('botania:mana_ring_greater', '{affix_data:{affixes:{"apotheosis:socket":1.0f}},mana:2000000}').strongNBT().toJson(),
            {item: "botania:terrasteel_ingot"},
            {item: "botania:mana_diamond"},
            {item: "mysticalagradditions:creative_essence"},
            Item.of('botania:mana_tablet', '{mana:500000}').strongNBT().toJson()
    ...
    event.recipes.extendedcrafting.shaped_table({
        ...
        key: {
            ...
            K: {item: 'mysticalagriculture:nether_quartz_seeds', },
            L: {item: 'mysticalagriculture:ruby_seeds', },
            M: {item: 'mysticalagriculture:azure_silver_seeds', },
            N: {item: 'mysticalagriculture:sapphire_seeds', },
            ...
            W: {item: 'mysticalagriculture:flux_infused_gem_seeds', },
            ...
            5: {item: 'mysticalagriculture:energized_steel_seeds', },
            ...
            g: {item: 'mysticalagriculture:flux_infused_ingot_seeds', },
            ...
            i: {item: 'mysticalagriculture:nether_seeds', },
    ...
    event.shaped(Item.of('ironjetpacks:jetpack', '{Id:"ironjetpacks:creative",Throttle:1.0d}').strongNBT(), ['ACA', 'BFB', 'DED'], {
        ...
        F: Item.of('ironjetpacks:jetpack', '{Id:"ironjetpacks:emerald",Throttle:1.0d}').strongNBT()
    ...
    event.recipes.extendedcrafting.shaped_table({
        ...
        key: {
            ...
            H: {item: 'thermal_extra:dragonsteel_glass', },
    ...
    event.recipes.extendedcrafting.shaped_table({
        ...
        key: {
            ...
            F: {item: 'botania:manasteel_ingot', },
